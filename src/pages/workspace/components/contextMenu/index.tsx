...
export default class CanvasContextMenu extends Component<CanvasContextMenuProps> {
  ...
  render() {
    ...
    return (
      <div className="menus">
        <div>
          <a className={(this.props.data.node || this.props.data.nodes) ? '' : "disabled"} onClick={this.onTop}>置顶</a>
        </div>
        <div>
          <a className={(this.props.data.node || this.props.data.nodes) ? '' : "disabled"} onClick={this.onBottom}>置底</a>
        </div>
        <div className="line" />
        {
        ...
        {/* <div>
          <a
            className={(this.props.data.node || this.props.data.nodes) ? '' : "disabled"}
            onClick={this.onLock}
